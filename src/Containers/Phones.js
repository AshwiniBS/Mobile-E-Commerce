...
//map dispatch to props ,It connects redux actions to react props. 
//The value of the global state is only changed with the help of an action. 

//mapstatetoprops store's state and it returns an object to be passed as props.
